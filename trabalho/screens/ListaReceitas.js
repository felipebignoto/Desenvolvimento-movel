...
export default function ListaDespesas({ navigation }) {
    const despesas = [
        { id: '1', descricao: 'Aluguel', valor: 1200.00, data: '05/10/2025', categoria: 'Moradia' },
        { id: '2', descricao: 'Supermercado', valor: 350.00, data: '10/10/2025', categoria: 'Alimentação' },
        { id: '3', descricao: 'Conta de luz', valor: 150.00, data: '12/10/2025', categoria: 'Moradia' },
    ];

    const renderItem = ({ item }) => (
        <TouchableOpacity 
            style={styles.itemCard}
            onPress={() => navigation.navigate('AdicionarDespesa', { item: item })}
            activeOpacity={0.7}
        >
